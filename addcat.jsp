  ...
  <div class="row" style="position: relative; background-color: rgba(0,0,0,0); margin-top: 10px;">
    <div class="col-md-4">
      <div class="contri">
        ...
        <ul class="nav nav-pills nav-stacked" style="width: 100%;">
          ...
          <li class="nav-item" style="width: 100%;">
          <a class="nav-link pilled active" href="addcat.jsp">Add Category</a>
          </li>
          </ul>
      </div>
      <div class="contri">
    ...
    <div class="col-md-8 scroll scrollbar scrollbar-sunny-morning">
      <div class="card text-center">
        ...
        <div class="card-body">
          <form action="addcatProcess.jsp" method="post">
            <div class="input-group form-group">
            <p style="margin: 5px;">Already available categories:</p> 
...
<% } %>
          ...
          <div class="input-group form-group">
            <p style="margin: 5px;">Add a new Category:</p>
            <input type="text" class="form-control" placeholder="Add a new category" name="addcat" style="text-transform:uppercase"required>
          </div>
        </div>
        <div class="card-footer text-muted">
        <div class="form-group">
            <input type="submit" value="Add Category" class="btn float-right login_btn" style="margin-left: 7px; width: auto;">
