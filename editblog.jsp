...
String blogid = request.getParameter("edit");
PreparedStatement pst = conn.prepareStatement("Select * FROM blogs WHERE blogid = '"+blogid+"'");
  ...
  <div class="row" style="position: relative; background-color: rgba(0,0,0,0); margin-top: 10px;">
    ...
    <div class="col-md-8 scroll scrollbar scrollbar-sunny-morning">
      <div class="card text-center">
        ...
        <div class="card-body">
          <form action="editblogProcess.jsp" method="post">
...
<% } %>
          ...
          <div class="input-group form-group">
            <input type="textarea" class="form-control" placeholder="Description" name="description" value="<%=description%>" required>
          ...
          <div class="input-group form-group">
            <textarea rows="15" cols="auto" name="content" class="form-control" placeholder="Enter your content here" style=" overflow-y: scroll; resize: none;" required><%=content%></textarea>
          </div>
        </div>
